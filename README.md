...
- **[Node.js](https://nodejs.org/pt)**: Ambiente de execução JavaScript no lado do servidor.
- **[Express.js](https://expressjs.com)**: Framework minimalista para criação de aplicações web e APIs em Node.js.
